...
export function HeroSection() {
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 surface-grid opacity-35"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-[7%] top-24 hidden h-20 w-px bg-line-subtle lg:block"
      />
      <div
        aria-hidden="true"
      ...
      <Container className="relative py-14 sm:py-16 lg:py-20 xl:py-24">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,.82fr)_minmax(0,1.18fr)] lg:gap-10 xl:gap-14">
          ...
          <div className="relative min-w-0 lg:-mr-4 xl:-mr-8">
            <div
              aria-hidden="true"
              className="absolute -inset-5 -z-10 rounded-[32px] border border-line-subtle opacity-65"
            />
            <div
              aria-hidden="true"
              className="absolute -right-4 top-8 -z-10 h-40 w-40 rounded-full bg-brand/[0.035] blur-2xl"
            />
