...
export const planosAssinatura = mysqlTable(
  'planos_assinatura',
  {
    ...
    permiteComentariosVideo: boolean('permite_comentarios_video').notNull().default(false),
    permiteComentariosPdf: boolean('permite_comentarios_pdf').notNull().default(false),
    permiteLinksPortalCliente: boolean('permite_links_portal_cliente').notNull().default(true),
    permiteVariosAprovadores: boolean('permite_varios_aprovadores').notNull().default(false),
    permiteHistoricoAvancado: boolean('permite_historico_avancado').notNull().default(false),
    permitePrioridadeSuporte: boolean('permite_prioridade_suporte').notNull().default(false),
    permiteFuncoesAvancadas: boolean('permite_funcoes_avancadas').notNull().default(false),
